<template>
  <el-dropdown-item icon="Check" @click="dialog.visible = true">
    两步验证
  </el-dropdown-item>
  ...
  <el-drawer
    ...
    center
  >
    <el-steps :active="dialog.active" align-center finish-status="success">
      <el-step title="创建验证器" />
      <el-step title="验证安装状态" />
      <el-step title="保存验证器" />
    </el-steps>

    <div v-if="dialog.active === 1">
    ...
    >
      ...
      >
        ...
        <el-col :span="3" />
        <el-col :span="6">
          <el-button type="primary" @click="handleAddOtpSecret">
            下一步
          </el-button>
        </el-col>
      </el-form-item>

      <el-form-item v-if="dialog.active === 1" label="验证器口令">
        <el-col :span="10">
          <el-input
